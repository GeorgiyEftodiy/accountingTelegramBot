...
inline_btn_1 = InlineKeyboardButton(text='50-тки', switch_inline_query_current_chat ='Тип(50) Количество=')
inline_btn_2 = InlineKeyboardButton(text='100-тки', switch_inline_query_current_chat ='Тип(100) Количество=')
